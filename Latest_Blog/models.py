...
class Latest_Blog(models.Model):
    ...
    image= models.FileField(max_length=200 , upload_to="Latest_Blog/", null=True)
    ...
    class Meta:
        ...
        verbose_name_plural = "Latest Blog"  # Plural name (same as singular, to avoid pluralization)