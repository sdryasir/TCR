    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, max_length=200, null=True, upload_to='Cars/')),
                ('new_car', models.CharField(blank=True, max_length=60, null=True)),
                ('title', models.CharField(blank=True, max_length=60, null=True)),
                ('passengers', models.CharField(blank=True, max_length=60, null=True)),
                ...
                ('feature_5', models.CharField(max_length=60, null=True)),
                ('feature_6', models.CharField(max_length=60, null=True)),
            ],
        ),
    ]
