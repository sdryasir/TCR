...
class Featured_Cars(models.Model):
    title = models.CharField(max_length=60,null=True)
    image= models.FileField(max_length=200 , upload_to="Featured_Cars/", null=True)
    ...
    car_image_1= models.FileField(max_length=200 , upload_to="Featured_Cars/", null=True,blank=True)
    car_image_2= models.FileField(max_length=200 , upload_to="Featured_Cars/", null=True,blank=True)
    car_image_3= models.FileField(max_length=200 , upload_to="Featured_Cars/", null=True,blank=True)
    car_image_4= models.FileField(max_length=200 , upload_to="Featured_Cars/", null=True,blank=True)
